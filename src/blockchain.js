    ...
    _addBlock(block) {
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                if(block.height > 0) {
                    await this.getBlockByHeight(this.height).then((prevBlock) => {
                ...
                reject('Error while adding a block');
            }            
        }).catch((error) => {
            console.log(error);
        });
    ...
    validateChain() {
        ...
        return new Promise(async (resolve, reject) => {
            for(var i = 0; i < self.chain.length; i++) {
                ...
                if (!isValidBlock) {
                    errorLog.push("\n This block has been changed - Block Index: " + i);
                } 
                if (previousHash !== "" && block.previousBlockHash !== previousHash) {
                    errorLog.push("\n The previous hash value doesn\'t match - Block Index: " + i);
                }
